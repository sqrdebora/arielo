...
<template>
  ...
  <div>
    ...
    <div class="disclaimer">Não temos o goal de ofender ou menosprezar ninguém. <br/> Please just have fun <br/><br/><RouterLink to="/privacy">Política de privacidade</RouterLink></div>
  </div>
