...
<template>
  <main>
    ...
    <div id="english">
      ...
      <p>
        Your privacy is important to us. It is Context's policy to respect your
        privacy with respect to any information we may collect from you on the
        <a href="https://arielo.netlify.app/">Arielo</a> website , and other websites
        we own and operate.
      </p>
      <p>
        We only ask for personal information when we really need it to provide
        you with a service. We do this by fair and lawful means, with your
        knowledge and consent. We also tell you why we are collecting it and how
        it will be used.
      </p>
      <p>
        We only retain collected information for as long as necessary to provide
        the requested service. When we store data, we protect it within
      ...
      <p>
        ...
        practices of these sites and cannot accept responsibility for their
        respective privacy policies.
      </p>
      <p>
        You are free to refuse our request for personal information, with the
        understanding that we may not be able to provide you with some of the
        services you require.
      </p>
      <p>
        Your continued use of our website will be deemed acceptance of our
        practices around privacy and personal information. If you have any
        questions about how we handle user data and personal information, please
        contact us.
      </p>
      <h2>Cookie Policy</h2>
      ...
      <p>
        ...
        collect, how we use it, and why we sometimes need to store these
        cookies. We will also share how you can prevent these cookies from being
      ...
      <p>
        ...
        add to this site. It is recommended that you leave all cookies if you
        are not sure whether or not you need them if they are used to provide a
        service you use.
      </p>
      <h3>Disable cookies</h3>
      <p>
        You can prevent cookies from being set by adjusting your browser
        settings (see your browser's Help for how to do this). Please be aware
        that disabling cookies will affect the functionality of this and many
        other websites you visit. Disabling cookies will generally result in the
        disabling of certain functionality and features of this website.
        Therefore, it is recommended that you do not disable cookies.
      </p>
      <h3>Third-party cookies</h3>
      <p>
        We use cookies provided by trusted third parties. The following section
        details which third-party cookies you may encounter through this
        website.
      </p>
      <ul>
        <li>
          ...
          understand how you use the website and how we can improve your
          experience. These cookies can track things like how much time you
          spend on the site and the pages you visit so that we can continue to
      ...
      <ul>
        <li>
          ...
          website so that we can continue to produce compelling content. These
          cookies can track things like the time you spend on the website or the
        ...
        <li>
          ...
          way the site looks. When we are still testing new features, these
          cookies may be used to ensure you receive a consistent experience
          while on the site, while we understand which optimizations our users
          appreciate most.
        </li>
        <li>
          As we sell products, it's important for us to understand statistics
          about how many visitors to our website actually buy, and so this is
          the type of data these cookies will track. This is important to you as
          it means we can make accurate business forecasts that allow us to
          analyze our advertising and product costs to ensure the best possible
          price.
        </li>
        <li>
          The Google AdSense service we use to serve ads uses a DoubleClick
          cookie to serve more relevant ads across the web and limit the number
          of times a particular ad is shown to you.
        </li>
        <li>
          For more information about AdSense, see the official AdSense Privacy
          FAQs.
        </li>
        <li>
          We use advertisements to offset the costs of running this site and to
          provide funding for future developments. The behavioral advertising
          cookies used by this website are designed to ensure that you provide
          the most relevant advertisements whenever possible, anonymously
          tracking your interests and featuring similar things that may be of
          interest to you.
        </li>
        <li>
          Various partners advertise on our behalf and affiliate tracking
          cookies simply allow us to see if our customers accessed the site
          through one of our partners' websites so that we can properly credit
          them and, where applicable, allow our affiliate partners to offer any
          promotion that may provide you to make a purchase.
        </li>
      </ul>
      <h3>User's commitment</h3>
      <p>
        The user undertakes to make adequate use of the contents and information
        that the Context offers on the website and with an enunciative, but not
        limiting character:
      </p>
      <ul>
        <li>
        ...
        <li>
          B) Not to disseminate propaganda or content of a racist, xenophobic,
          or unlucky nature, any type of illegal pornography, in support of
          terrorism or against human rights;
        </li>
        <li>
          C) Not to cause damage to the physical (hardware) and logical
          (software) systems of the Context, its suppliers or third parties, to
          introduce or disseminate computer viruses or any other hardware or
          software systems that are capable of causing damages mentioned above.
        </li>
      </ul>
      <h3>Amendment of this Privacy Policy</h3>
      <p>
        The current version of the Privacy Policy was formulated and last
        updated in: September/2022.
      </p>
      <p>
        We reserve the right to modify this Privacy Policy at any time, mainly
        depending on the adequacy of any changes made to our website or in the
        legislative scope. We recommend that you review it frequently.
      </p>
      <p>
        Any changes will take effect as of their publication on our website and
        we will always notify you of the changes.
      </p>
      <p>
        By using our services and providing your personal data after such
        modifications, you consent to them.
      </p>
      <h3>More information</h3>
      <p>
        Hopefully this is clear and, as mentioned earlier, if there's something
        you're not sure you need or not, it's generally safer to leave cookies
        enabled in case it interacts with one of the features you use on our
        site.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="#cmp" onclick="if(window.__cmp === undefined){console.warn('User is not in the EU - Consent Choices can only be configured when User is in the EU')}else{window.__cmp('showConsentTool')}">here</a>.
      </p>
    </div>
    <div id="portugues" lang="pt-BR">
      ...
      <p>
        A sua privacidade é importante para nós. É política do Arielo
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site <a href="https://arielo.netlify.app/">Arielo</a>, e
      ...
      <p>
        ...
        informação que o Arielo oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          (softwares) do Arielo, de seus fornecedores ou terceiros, para
      ...
      <p>
        ...
        <strong>Julho</strong>/<strong>2024</strong>.
      </p>
      <p>
        A publicidade total ou parcial neste site ou aplicativo é gerenciada
        pela Playwire LLC. Se os serviços de publicidade do editor Playwire
        forem usados, a Playwire LLC poderá coletar e usar determinados dados
        agregados e anonimizados para fins publicitários. Para saber mais sobre
        os tipos de dados coletados, como os dados são usados e suas escolhas
        como usuário, visite
        <a href="https://www.playwire.com/privacy-policy">https://www.playwire.com/privacy-policy</a>.
      </p>
    </div>
